 ...
 * tuna.js
 * 
 * Набор утилитарных функций организации работы приложения.
 * 
...
tuna.isArray = function(object) {
	return object && typeof object.push === 'function' && 
		   !isNaN(object.length);
};
...
tuna.implement = function(Class, Interface) {
	for (var func in Interface.prototype) {
		if (typeof Interface.prototype[func] === 'function') {
			Class.prototype[func] = Interface.prototype[func];
		}
	}
};
